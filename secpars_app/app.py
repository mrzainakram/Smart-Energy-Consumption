            ...
            if is_project_query:
                with st.spinner("🔍 Searching in project data..."):
                    ...
                    if rel:
                        ...
                        # Beautiful project knowledge response
                        st.markdown(f"""
...
<h4 style="margin: 0 0 15px 0; color: #fff;">🏆 Project Knowledge Response</h4>
<p style="margin: 0; line-height: 1.6;">{ans}</p>
<p style="margin: 15px 0 0 0; font-size: 0.9em; opacity: 0.8;">[Sourced from SECPARS Project Knowledge Base]</p>
</div>
""", unsafe_allow_html=True)
                    else:
                        ...
                        with st.spinner("🤖 Using Gemini AI..."):
                            ...
                            # Beautiful Gemini response
                            st.markdown(f"""
<div style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); padding: 20px; border-radius: 15px; color: white; margin: 10px 0;">
<h4 style="margin: 0 0 15px 0; color: #fff;">🌐 Gemini AI Response</h4>
<p style="margin: 0; line-height: 1.6;">{ans}</p>
<p style="margin: 15px 0 0 0; font-size: 0.9em; opacity: 0.8;">[Generated by Gemini AI]</p>
</div>
""", unsafe_allow_html=True)
            else:
                ...
                with st.spinner("🤖 Using Gemini AI..."):
                    ...
                    # Beautiful general response
                    st.markdown(f"""
<div style="background: linear-gradient(135deg, #4ecdc4 0%, #44a08d 100%); padding: 20px; border-radius: 15px; color: white; margin: 10px 0;">
<h4 style="margin: 0 0 15px 0; color: #fff;">🌐 AI Response</h4>
<p style="margin: 0; line-height: 1.6;">{ans}</p>
<p style="margin: 15px 0 0 0; font-size: 0.9em; opacity: 0.8;">[Generated by Gemini AI]</p>
</div>
""", unsafe_allow_html=True)
