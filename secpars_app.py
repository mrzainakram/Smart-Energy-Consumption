...
def _system(lang: str) -> str:
    ...
    return (
        ...
        "Be warm, concise, and speak naturally like a helpful person. Always prioritize project knowledge when answering energy-related questions. For general questions, provide helpful answers. Keep responses to-the-point and practical. "
